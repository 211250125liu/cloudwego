...
type StudentService interface {
	Register(ctx context.Context, theStudent *Student) (r *RegisterResp, err error)
...
func (p *StudentServiceClient) Register(ctx context.Context, theStudent *Student) (r *RegisterResp, err error) {
	var _args StudentServiceRegisterArgs
	_args.TheStudent = theStudent
...
func (p *studentServiceProcessorRegister) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.Register(ctx, args.TheStudent); err2 != nil {
...
type StudentServiceRegisterArgs struct {
	TheStudent *Student `thrift:"theStudent,1" frugal:"1,default,Student" json:"theStudent"`
}
...
var StudentServiceRegisterArgs_TheStudent_DEFAULT *Student

func (p *StudentServiceRegisterArgs) GetTheStudent() (v *Student) {
	if !p.IsSetTheStudent() {
		return StudentServiceRegisterArgs_TheStudent_DEFAULT
	}
	return p.TheStudent
}
func (p *StudentServiceRegisterArgs) SetTheStudent(val *Student) {
	p.TheStudent = val
}
...
func (p *StudentServiceRegisterArgs) IsSetTheStudent() bool {
	return p.TheStudent != nil
}
...
func (p *StudentServiceRegisterArgs) ReadField1(iprot thrift.TProtocol) error {
	p.TheStudent = NewStudent()
	if err := p.TheStudent.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *StudentServiceRegisterArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("theStudent", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.TheStudent.Write(oprot); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *StudentServiceRegisterArgs) DeepEqual(ano *StudentServiceRegisterArgs) bool {
	...
	if !p.Field1DeepEqual(ano.TheStudent) {
		return false
	}
	return true
}
